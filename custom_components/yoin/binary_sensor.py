...
async def async_setup_entry(
    ...
    """Set up the Yoin binary sensors."""
    ...
    entities: list[YoinBinarySensor] = []
...
class YoinBinarySensor(YoinEntity, BinarySensorEntity):
    """Representation of a Yoin binary sensor."""
